...
export function seedData(): FlowLogData {
  ...
  const inventory: FlowLogData["inventory"] = [
    { id: "INV-001", sku: "FRZ-BEEF-PATTY-4OZ", name: "Beef Patties 4oz", category: "frozen_meat", unit: "case", currentStock: 142, reorderPoint: 50, reorderQty: 200, maxCapacity: 400, costPerUnit: 48.5, weightPerUnitKg: 5, sellPrice: 72.0, supplierId: "SUP-001", warehouseZone: "A3", expiryDates: [{ qty: 60, expiresOn: d(16) }, { qty: 82, expiresOn: d(30) }], lastRestocked: d(-9), notes: "" },
    { id: "INV-002", sku: "FRZ-CHICKEN-THIGH-5KG", name: "Chicken Thighs 5kg", category: "frozen_meat", unit: "case", currentStock: 38, reorderPoint: 40, reorderQty: 150, maxCapacity: 300, costPerUnit: 62.0, weightPerUnitKg: 5, sellPrice: 88.0, supplierId: "SUP-001", warehouseZone: "A4", expiryDates: [{ qty: 38, expiresOn: d(4) }], lastRestocked: d(-14), notes: "Check freezer unit 4 temps" },
    { id: "INV-003", sku: "FRZ-PORK-BELLY-SLICED", name: "Sliced Pork Belly", category: "frozen_meat", unit: "case", currentStock: 0, reorderPoint: 30, reorderQty: 100, maxCapacity: 200, costPerUnit: 55.0, weightPerUnitKg: 5, sellPrice: 79.0, supplierId: "SUP-001", warehouseZone: "A3", expiryDates: [], lastRestocked: d(-23), notes: "OUT OF STOCK" },
    { id: "INV-004", sku: "FRZ-SALMON-FILLET-VAC", name: "Vacuum Salmon Fillets", category: "frozen_meat", unit: "kg", currentStock: 210, reorderPoint: 80, reorderQty: 300, maxCapacity: 600, costPerUnit: 18.5, weightPerUnitKg: 1, sellPrice: 26.0, supplierId: "SUP-005", warehouseZone: "B1", expiryDates: [{ qty: 210, expiresOn: d(36) }], lastRestocked: d(-6), notes: "" },
    { id: "INV-005", sku: "FRS-LEAFY-MIXED-KG", name: "Mixed Leafy Greens", category: "fresh_produce", unit: "kg", currentStock: 85, reorderPoint: 100, reorderQty: 200, maxCapacity: 300, costPerUnit: 3.2, weightPerUnitKg: 1, sellPrice: 5.5, supplierId: "SUP-002", warehouseZone: "C1", expiryDates: [{ qty: 85, expiresOn: d(2) }], lastRestocked: d(-1), notes: "Daily order needed" },
    { id: "INV-006", sku: "FRS-TOMATO-BOX-5KG", name: "Cherry Tomatoes 5kg Box", category: "fresh_produce", unit: "box", currentStock: 44, reorderPoint: 30, reorderQty: 80, maxCapacity: 150, costPerUnit: 12.8, weightPerUnitKg: 5, sellPrice: 19.0, supplierId: "SUP-002", warehouseZone: "C2", expiryDates: [{ qty: 44, expiresOn: d(3) }], lastRestocked: d(-2), notes: "" },
    { id: "INV-007", sku: "FRS-ONION-BROWN-10KG", name: "Brown Onions 10kg", category: "fresh_produce", unit: "bag", currentStock: 120, reorderPoint: 50, reorderQty: 150, maxCapacity: 400, costPerUnit: 8.5, weightPerUnitKg: 10, sellPrice: 13.0, supplierId: "SUP-002", warehouseZone: "C3", expiryDates: [{ qty: 120, expiresOn: d(26) }], lastRestocked: d(-12), notes: "" },
    { id: "INV-008", sku: "FRS-MUSHROOM-SHIITAKE", name: "Shiitake Mushrooms 1kg", category: "fresh_produce", unit: "pack", currentStock: 22, reorderPoint: 40, reorderQty: 100, maxCapacity: 200, costPerUnit: 9.8, weightPerUnitKg: 1, sellPrice: 15.5, supplierId: "SUP-002", warehouseZone: "C1", expiryDates: [{ qty: 22, expiresOn: d(1) }], lastRestocked: d(-4), notes: "" },
    { id: "INV-009", sku: "DAI-CHEESE-CHEDDAR-5KG", name: "Cheddar Cheese Block 5kg", category: "dairy", unit: "block", currentStock: 56, reorderPoint: 30, reorderQty: 100, maxCapacity: 200, costPerUnit: 34.0, weightPerUnitKg: 5, sellPrice: 52.0, supplierId: "SUP-004", warehouseZone: "D1", expiryDates: [{ qty: 56, expiresOn: d(47) }], lastRestocked: d(-16), notes: "" },
    { id: "INV-010", sku: "DAI-BUTTER-UNSALTED-1KG", name: "Unsalted Butter 1kg", category: "dairy", unit: "block", currentStock: 188, reorderPoint: 60, reorderQty: 200, maxCapacity: 400, costPerUnit: 8.2, weightPerUnitKg: 1, sellPrice: 12.5, supplierId: "SUP-004", warehouseZone: "D1", expiryDates: [{ qty: 188, expiresOn: d(21) }], lastRestocked: d(-7), notes: "" },
    { id: "INV-011", sku: "DAI-CREAM-HEAVY-1L", name: "Heavy Whipping Cream 1L", category: "dairy", unit: "carton", currentStock: 14, reorderPoint: 40, reorderQty: 120, maxCapacity: 240, costPerUnit: 4.5, weightPerUnitKg: 1, sellPrice: 7.0, supplierId: "SUP-004", warehouseZone: "D2", expiryDates: [{ qty: 14, expiresOn: d(1) }], lastRestocked: d(-8), notes: "CRITICAL — low and near expiry" },
    { id: "INV-012", sku: "DRY-RICE-JASMINE-25KG", name: "Jasmine Rice 25kg", category: "dry_goods", unit: "bag", currentStock: 310, reorderPoint: 100, reorderQty: 300, maxCapacity: 600, costPerUnit: 28.0, weightPerUnitKg: 25, sellPrice: 40.0, supplierId: "SUP-003", warehouseZone: "E1", expiryDates: [{ qty: 310, expiresOn: d(342) }], lastRestocked: d(-35), notes: "" },
    { id: "INV-013", sku: "DRY-FLOUR-AP-25KG", name: "All-Purpose Flour 25kg", category: "dry_goods", unit: "bag", currentStock: 95, reorderPoint: 50, reorderQty: 200, maxCapacity: 400, costPerUnit: 22.0, weightPerUnitKg: 25, sellPrice: 33.0, supplierId: "SUP-003", warehouseZone: "E2", expiryDates: [{ qty: 95, expiresOn: d(160) }], lastRestocked: d(-22), notes: "" },
    { id: "INV-014", sku: "DRY-SUGAR-WHITE-25KG", name: "White Sugar 25kg", category: "dry_goods", unit: "bag", currentStock: 160, reorderPoint: 60, reorderQty: 200, maxCapacity: 400, costPerUnit: 19.5, weightPerUnitKg: 25, sellPrice: 28.0, supplierId: "SUP-003", warehouseZone: "E2", expiryDates: [{ qty: 160, expiresOn: d(252) }], lastRestocked: d(-27), notes: "" },
    { id: "INV-015", sku: "BEV-MILK-WHOLE-1L", name: "Whole Milk 1L", category: "beverages", unit: "carton", currentStock: 330, reorderPoint: 120, reorderQty: 400, maxCapacity: 800, costPerUnit: 2.1, weightPerUnitKg: 1, sellPrice: 3.2, supplierId: "SUP-004", warehouseZone: "D3", expiryDates: [{ qty: 330, expiresOn: d(11) }], lastRestocked: d(-4), notes: "" },
    { id: "INV-016", sku: "BEV-OJ-PURE-1L", name: "Pure Orange Juice 1L", category: "beverages", unit: "carton", currentStock: 28, reorderPoint: 80, reorderQty: 200, maxCapacity: 400, costPerUnit: 3.8, weightPerUnitKg: 1, sellPrice: 5.8, supplierId: "SUP-004", warehouseZone: "D3", expiryDates: [{ qty: 28, expiresOn: d(5) }], lastRestocked: d(-14), notes: "" },
    { id: "INV-017", sku: "PKG-BOX-COLD-MED", name: "Insulated Cold Box (Med)", category: "packaging", unit: "unit", currentStock: 820, reorderPoint: 300, reorderQty: 1000, maxCapacity: 3000, costPerUnit: 1.2, weightPerUnitKg: 0.5, sellPrice: 1.2, supplierId: "SUP-003", warehouseZone: "F1", expiryDates: [], lastRestocked: d(-45), notes: "" },
    { id: "INV-018", sku: "PKG-ICE-GEL-PACK", name: "Gel Ice Pack 400g", category: "packaging", unit: "unit", currentStock: 240, reorderPoint: 500, reorderQty: 2000, maxCapacity: 5000, costPerUnit: 0.85, weightPerUnitKg: 0.4, sellPrice: 0.85, supplierId: "SUP-003", warehouseZone: "F2", expiryDates: [], lastRestocked: d(-19), notes: "LOW — impacting cold chain ops" },
  ];
